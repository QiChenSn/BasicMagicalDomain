...
public class MagicalAltarMenu extends AbstractContainerMenu {
    ...
    public MagicalAltarMenu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
        this(containerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()));
    }

    public MagicalAltarMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        super(ModMenuType.MagicalAltar_MENU.get(), containerId);
        this.blockEntity = ((MagicalAltarEntity) blockEntity);
